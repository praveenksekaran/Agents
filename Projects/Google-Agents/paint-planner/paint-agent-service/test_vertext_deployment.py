...
app_name = os.environ.get("APP_NAME", "paint agent servicer")
...
handler = CloudLoggingHandler(cloud_logging_client, name="paint-agent-servicer")
...
room_layout = """
    hi. I would fill with json later.
"""
